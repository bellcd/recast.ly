...
var VideoListEntry = ({updateCurrentVideo, video: {snippet: {title, description, thumbnails: {default: {url}}}}}) => (
  <div className="video-list-entry media">
    <div className="media-left media-middle">
      <img className="media-object" src={url} alt="" />
    </div>
    <div className="media-body">
      <div onClick={() => {updateCurrentVideo(video)}}><h5><em>{title}</em></h5></div>
